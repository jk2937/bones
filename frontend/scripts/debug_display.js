Bones.DebugDisplay = { 
    init: function() {
        ...
        this.variables = ["Bones.Timer.fps", "Bones.Timer.total_lag_frames", "", "Bones.Input.Keyboard.ControlStates[\"left\"].pressed", "Bones.Input.Keyboard.ControlStates[\"right\"].pressed", "Bones.Input.Keyboard.ControlStates[\"jump\"].pressed", "", "Bones.Input.Keyboard.ControlStates[\"left\"].pressed_this_frame", "Bones.Input.Keyboard.ControlStates[\"right\"].pressed_this_frame", "Bones.Input.Keyboard.ControlStates[\"jump\"].pressed_this_frame", "", "Bones.Input.Mouse.ControlStates.x", "Bones.Input.Mouse.ControlStates.y", "", "Bones.Input.Mouse.ControlStates.click", "Bones.Input.Mouse.ControlStates.click_this_frame", "", "Bones.Input.Touch.ControlStates.x", "Bones.Input.Touch.ControlStates.y", "", "Bones.Input.Touch.ControlStates.click", "Bones.Input.Touch.ControlStates.click_this_frame", "", "Bones.World.npcs[0].stuck_time", "Bones.World.npcs[0].kicks_counter", "Bones.World.npcs[0].kicks_per_minute", "Bones.World.npcs[0].kick_timer / 60"]
